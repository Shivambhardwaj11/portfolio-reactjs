       ...
       <div className="container mx-auto mx-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-8">
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="mailto:bhardwajshivambsr2000@gmail.com" 
                                className="text-muted-foreground hover:text-primary transition-colors"
                                >bhardwajshivambsr2000@gmail.com</a>
                            </div>
                        </div>
                        <div className="flex items-start space-x-4">
                            <div className="p-3 rounded-full bg-primary/10">
                    ...
                    <div className="pt-8">
                        <h4 className="font-medium md-4">Connect With Me</h4>
                    ...
                    <form className="space-y-6">
                        <div>
                         ...
                         <div>
                            ...
                            <textarea id="message" name="message" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary" placeholder="Message..." />
                        </div>
